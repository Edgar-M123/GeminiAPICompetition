...
def audio_only_long():
  print("\nCall where LONG audio is uploaded then provided to prompt")
  t1 = time.perf_counter()

  video_filename = "Recording-long.mp3"
  ...
  text = "What is happening in this audio? Be as descriptive as possible regarding the topic, the way the person is talking, and anything else worth noting."
